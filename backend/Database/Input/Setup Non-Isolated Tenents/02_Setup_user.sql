...
BEGIN TRY
    ...
    IF @RoleId IS NULL
    BEGIN
        INSERT INTO dbo.AspNetRoles (Id, Name, NormalizedName, ConcurrencyStamp, Description, TenantId)
        VALUES (NEWID(), @RoleName, UPPER(@RoleName), NEWID(), 'Tenant role', @TenantId);
