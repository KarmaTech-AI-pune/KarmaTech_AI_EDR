...
-- Check if ScoringCriteria table has data
IF NOT EXISTS (SELECT TOP 1 1 FROM ScoringCriteria)
BEGIN
    ...
    PRINT 'ScoringCriteria data inserted successfully';
END
ELSE
BEGIN
    PRINT 'ScoringCriteria data already exists, skipping insert';
END

-- Check if ScoreRange table has data
IF NOT EXISTS (SELECT TOP 1 1 FROM ScoreRange)
BEGIN
    ...
    PRINT 'ScoreRange data inserted successfully';
END
ELSE
BEGIN
    PRINT 'ScoreRange data already exists, skipping insert';
END

-- Check if ScoringDescription table has data
IF NOT EXISTS (SELECT TOP 1 1 FROM ScoringDescription)
BEGIN
    ...
    PRINT 'ScoringDescription data inserted successfully';
END
ELSE
BEGIN
    PRINT 'ScoringDescription data already exists, skipping insert';
END


-- Check if ScoringDescriptionSummarry table has data
IF NOT EXISTS (SELECT TOP 1 1 FROM ScoringDescriptionSummarry)
BEGIN
    ...
    PRINT 'ScoringDescriptionSummarry data inserted successfully';
END
ELSE
BEGIN
