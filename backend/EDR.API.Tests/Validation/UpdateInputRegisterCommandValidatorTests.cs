...
{
    public class UpdateInputRegisterCommandValidatorTests
    {
        private readonly UpdateInputRegisterCommandValidator _validator;

        public UpdateInputRegisterCommandValidatorTests()
        {
            _validator = new UpdateInputRegisterCommandValidator();
        }
