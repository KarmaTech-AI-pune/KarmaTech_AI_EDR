...
using EDR.Domain.Entities; // Assuming Permission entity is here
using EDR.Repositories.Interfaces; // For IPermissionRepository
using EDR.Application.Services.IContract; // For ITenantService, ICurrentUserService
using System;
