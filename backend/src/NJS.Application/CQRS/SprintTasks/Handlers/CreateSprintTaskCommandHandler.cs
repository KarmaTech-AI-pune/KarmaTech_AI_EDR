...
namespace NJS.Application.CQRS.SprintTasks.Handlers
{
    public class CreateSprintTaskCommandHandler : IRequestHandler<CreateSprintTaskCommand, string>
    {
        ...
        public async Task<string> Handle(CreateSprintTaskCommand request, CancellationToken cancellationToken)
        {
            ...
            if (sprintTaskDto.Subtasks != null && sprintTaskDto.Subtasks.Any())
            {
                sprintTask.Subtasks = new List<SprintSubtask>();
                foreach (var subtaskDto in sprintTaskDto.Subtasks)
                {
                    sprintTask.Subtasks.Add(new SprintSubtask
                    {
                        // SubtaskId will be auto-generated by the database
                        ...
                        Subtaskcomments = subtaskDto.Subtaskcomments, // Changed from int? to string?
                        ...
                        Taskid = sprintTask.Taskid // Link subtask to parent task
                    });
                }
            }
