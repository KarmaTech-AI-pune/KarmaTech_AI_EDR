...
using NJS.Domain.Enums; // Added for ProjectStatusEnum

namespace NJS.Application.CQRS.Dashboard.ProfitMargin.Handler
{
    public class GetProfitMarginQueryHandler : IRequestHandler<Query.GetProfitMarginQuery, ProfitMarginDto>
    {
        ...
        public async Task<ProfitMarginDto> Handle(Query.GetProfitMarginQuery request, CancellationToken cancellationToken)
        {
