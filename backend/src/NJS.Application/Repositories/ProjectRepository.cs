...
namespace NJS.Application.Repositories
{
    public class ProjectRepository : IProjectRepository
    {
        ...
        public ProjectRepository(IOpportunityTrackingRepository opportunityTrackingRepository)
        {
        ...
        public void Add(Project project)
        {
            ...
            {
                var opportunityTracking = new OpportunityTracking
                {
                ...
                _opportunityTrackingRepository.AddAsync(opportunityTracking);
            }
        }
        ...
        public void Update(Project project)
        {
            ...
            if (existingProject != null)
            {
                ...
                existingProject.ClientSector = project.ClientSector;
                existingProject.Sector = project.Sector;
                existingProject.EstimatedCost = project.EstimatedCost;
                existingProject.StartDate = project.StartDate;
                existingProject.EndDate = project.EndDate;
                existingProject.Status = project.Status;
                existingProject.Progress = project.Progress;
                existingProject.ContractType = project.ContractType;
