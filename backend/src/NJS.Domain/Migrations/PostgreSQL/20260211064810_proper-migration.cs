        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateOfSubmission = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    PercentageChanceOfProjectHappening = table.Column<decimal>(type: "numeric(18,2)", precision: 5, scale: 2, nullable: true),
                    PercentageChanceOfNJSSuccess = table.Column<decimal>(type: "numeric(18,2)", precision: 5, scale: 2, nullable: true),
                    ...
                    NetNJSRevenue = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    ...
                    LikelyStartDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NjsInwardNo = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    ...
                    RepliedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    UpdatedBy = table.Column<string>(type: "text", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DueDateContract = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    DueDatePlanned = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantId = table.Column<int>(type: "integer", nullable: false),
                    MonthlyProgressId = table.Column<int>(type: "integer", nullable: false),
                    DateOfIssueWOLOI = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CompletionDateAsPerContract = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CompletionDateAsPerExtension = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubtaskcreatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    SubtaskupdatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaskcreatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    TaskupdatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
