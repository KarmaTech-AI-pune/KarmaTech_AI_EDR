        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectHistories_AspNetUsers_ActionBy",
                        column: x => x.ActionBy,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProjectHistories_AspNetUsers_AssignedToId",
                        column: x => x.AssignedToId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProjectHistories_OpportunityStatuses_StatusId",
                        column: x => x.StatusId,
                        principalTable: "OpportunityStatuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectHistories_ActionBy",
                table: "ProjectHistories",
                column: "ActionBy");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectHistories_AssignedToId",
                table: "ProjectHistories",
                column: "AssignedToId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectHistories_StatusId",
                table: "ProjectHistories",
                column: "StatusId");
