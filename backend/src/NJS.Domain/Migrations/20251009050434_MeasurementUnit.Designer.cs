...
namespace NJS.Domain.Migrations
{
    ...
    [Migration("20251009050434_MeasurementUnit")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NJS.Domain.Entities.TodoNewProject", b =>
                {
                    b.Property<int>("ProjectId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("TodoNewProjects");
                });

            modelBuilder.Entity("NJS.Domain.Entities.TodoNewSubtask", b =>
                {
                    ...
                    b.Property<int?>("Subtaskcomments")
                        .HasColumnType("int");
                    ...
                    b.ToTable("TodoNewSubtasks");
                });

            modelBuilder.Entity("NJS.Domain.Entities.TodoNewTask", b =>
                {
                    b.Property<string>("Taskid")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("TodoNewTasks");
                });

            modelBuilder.Entity("NJS.Domain.Entities.TodoNewTeamMember", b =>
                {
                    b.Property<string>("Assineid")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("Assineavatar")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Assinename")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("Assineid");

                    b.ToTable("TodoNewTeamMembers");
                });
            ...
            modelBuilder.Entity("NJS.Domain.Entities.WBSOption", b =>
                {
                    ...
                    b.Property<int?>("TodoProjectScheduleId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NJS.Domain.Entities.TodoNewSubtask", b =>
                {
                    b.HasOne("NJS.Domain.Entities.TodoNewTask", "ParentTask")
                        .WithMany("Subtasks")
            ...
            modelBuilder.Entity("NJS.Domain.Entities.TodoNewTask", b =>
                {
                    b.HasOne("NJS.Domain.Entities.TodoNewProject", "Project")
                        .WithMany("Tasks")
                        .HasForeignKey("ProjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
