...
namespace NJS.Domain.Interceptors
{
    public class AuditSaveChangesInterceptor : SaveChangesInterceptor
    {
        private readonly IAuditSubject _auditSubject;
        private readonly NJS.Domain.Services.IAuditContext _auditContext;

        public AuditSaveChangesInterceptor(IAuditSubject auditSubject, NJS.Domain.Services.IAuditContext auditContext)
        {
        ...
        public override async ValueTask<InterceptionResult<int>> SavingChangesAsync(DbContextEventData eventData, InterceptionResult<int> result, CancellationToken cancellationToken = default)
        {
            ...
            {
                if (entry.Entity is NJS.Domain.Entities.AuditLog) continue;
