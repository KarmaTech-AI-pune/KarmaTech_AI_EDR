...
namespace EDR.Application.CQRS.JobStartForm.Handlers
{
    public class AddJobStartFormCommandHandler : IRequestHandler<AddJobStartFormCommand, int>
    {
        ...
        {
            var jobStartForm = new EDR.Domain.Entities.JobStartForm
            {
            ...
            await _unitOfWork.GetRepository<EDR.Domain.Entities.JobStartForm>().AddAsync(jobStartForm); // Use generic repository
