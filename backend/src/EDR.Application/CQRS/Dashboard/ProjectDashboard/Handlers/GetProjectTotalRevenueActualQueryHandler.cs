...
{
    public class GetProjectTotalRevenueActualQueryHandler : IRequestHandler<GetProjectTotalRevenueActualQuery, TotalRevenueActualDto>
    {
        private readonly IProjectDashboardRepository _projectDashboardRepository;

        public GetProjectTotalRevenueActualQueryHandler(IProjectDashboardRepository projectDashboardRepository)
        {
            _projectDashboardRepository = projectDashboardRepository;
        }

        public async Task<TotalRevenueActualDto> Handle(GetProjectTotalRevenueActualQuery request, CancellationToken cancellationToken)
        {
