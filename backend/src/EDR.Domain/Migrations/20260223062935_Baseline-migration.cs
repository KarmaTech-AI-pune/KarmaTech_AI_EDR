        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MigrationResultId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ByDate = table.Column<string>(type: "text", nullable: true),
                    Comments = table.Column<string>(type: "text", nullable: true),
                    Score = table.Column<int>(type: "integer", nullable: false),
                    ShowComments = table.Column<bool>(type: "boolean", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BidFees = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    Emd = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    ...
                    PercentageChanceOfProjectHappening = table.Column<decimal>(type: "numeric(18,2)", precision: 5, scale: 2, nullable: true),
                    PercentageChanceOfEDRSuccess = table.Column<decimal>(type: "numeric(18,2)", precision: 5, scale: 2, nullable: true),
                    LikelyCompetition = table.Column<string>(type: "text", nullable: true),
                    GrossRevenue = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    NetEDRRevenue = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstimatedProjectCost = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    EstimatedProjectFee = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    ...
                    StartDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    EndDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    CapitalValue = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    Status = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    TenantId = table.Column<int>(type: "integer", nullable: false),
                    ReleaseNotesId = table.Column<int>(type: "integer", nullable: false),
                    ChangeType = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    Description = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                    CommitSha = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: true),
                    JiraTicket = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    Impact = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    TenantId = table.Column<int>(type: "integer", nullable: false),
                    TypeOfBid = table.Column<int>(type: "integer", nullable: false),
                    Sector = table.Column<string>(type: "text", nullable: true),
                    BdHead = table.Column<string>(type: "text", nullable: true),
                    Office = table.Column<string>(type: "text", nullable: true),
                    RegionalBDHead = table.Column<string>(type: "text", nullable: true),
                    Region = table.Column<string>(type: "text", nullable: true),
                    TypeOfClient = table.Column<string>(type: "text", nullable: true),
                    EnderFee = table.Column<string>(type: "text", nullable: true),
                    Emd = table.Column<string>(type: "text", nullable: true),
                    OpportunityId = table.Column<int>(type: "integer", nullable: false),
                    ScoringCriteriaId = table.Column<int>(type: "integer", nullable: true),
                    ScoreRangeId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_GoNoGoDecisionOpportunities_ScoringCriteria_ScoringCriteria~",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    TenantId = table.Column<int>(type: "integer", nullable: false),
                    ScoringDescriptionID = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ScoringDescriptionSummarry_ScoringDescription_ScoringDescri~",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    TenantId = table.Column<int>(type: "integer", nullable: false),
                    DocumentCategoriesJson = table.Column<string>(type: "text", nullable: true),
                    OpportunityId = table.Column<int>(type: "integer", nullable: false),
                    UserId = table.Column<string>(type: "text", nullable: false),
                    RegionalMangerId = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Region = table.Column<string>(type: "text", nullable: true),
                    TypeOfClient = table.Column<string>(type: "text", nullable: true),
                    TenderFee = table.Column<double>(type: "double precision", nullable: false),
                    Emd = table.Column<double>(type: "double precision", nullable: false),
                    ...
                    VersionStatus = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PMWorkflowStatusId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantId = table.Column<int>(type: "integer", nullable: false),
                    ProjectId = table.Column<int>(type: "integer", nullable: false),
                    ActivityNo = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    ...
                    QualityIssues = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    Completion = table.Column<string>(type: "character varying(1)", maxLength: 1, nullable: false),
                    CheckedBy = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    ...
                    Maker = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    Checker = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantId = table.Column<int>(type: "integer", nullable: false),
                    ProjectId = table.Column<int>(type: "integer", nullable: false),
                    IncomingLetterNo = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    LetterDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    EdrInwardNo = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    ...
                    AttachmentDetails = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    ActionTaken = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    StoragePath = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    Remarks = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    RepliedDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    UpdatedBy = table.Column<string>(type: "text", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantId = table.Column<int>(type: "integer", nullable: false),
                    ProjectId = table.Column<int>(type: "integer", nullable: false),
                    LetterNo = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    LetterDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    ...
                    StoragePath = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    Remarks = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    Acknowledgement = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    UpdatedBy = table.Column<string>(type: "text", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantId = table.Column<int>(type: "integer", nullable: false),
                    ProjectId = table.Column<int>(type: "integer", nullable: false),
                    BidType = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    Sector = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    TenderFee = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    EMDAmount = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    MarketingPlanScore = table.Column<int>(type: "integer", nullable: false),
                    MarketingPlanComments = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: false),
                    ClientRelationshipScore = table.Column<int>(type: "integer", nullable: false),
                    ClientRelationshipComments = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: false),
                    ProjectKnowledgeScore = table.Column<int>(type: "integer", nullable: false),
                    ProjectKnowledgeComments = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: false),
                    TechnicalEligibilityScore = table.Column<int>(type: "integer", nullable: false),
                    TechnicalEligibilityComments = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: false),
                    FinancialEligibilityScore = table.Column<int>(type: "integer", nullable: false),
                    FinancialEligibilityComments = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: false),
                    StaffAvailabilityScore = table.Column<int>(type: "integer", nullable: false),
                    StaffAvailabilityComments = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: false),
                    CompetitionAssessmentScore = table.Column<int>(type: "integer", nullable: false),
                    CompetitionAssessmentComments = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: false),
                    CompetitivePositionScore = table.Column<int>(type: "integer", nullable: false),
                    CompetitivePositionComments = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: false),
                    FutureWorkPotentialScore = table.Column<int>(type: "integer", nullable: false),
                    FutureWorkPotentialComments = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: false),
                    ProfitabilityScore = table.Column<int>(type: "integer", nullable: false),
                    ProfitabilityComments = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: false),
                    ResourceAvailabilityScore = table.Column<int>(type: "integer", nullable: false),
                    ResourceAvailabilityComments = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: false),
                    BidScheduleScore = table.Column<int>(type: "integer", nullable: false),
                    BidScheduleComments = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: false),
                    TotalScore = table.Column<int>(type: "integer", nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantId = table.Column<int>(type: "integer", nullable: false),
                    ProjectId = table.Column<int>(type: "integer", nullable: false),
                    DataReceived = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    ReceiptDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    ReceivedFrom = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    FilesFormat = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    NoOfFiles = table.Column<int>(type: "integer", nullable: false),
                    FitForPurpose = table.Column<bool>(type: "boolean", nullable: false),
                    Check = table.Column<bool>(type: "boolean", nullable: false),
                    CheckedBy = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    CheckedDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    Custodian = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    StoragePath = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    Remarks = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ManpowerTotal = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OldValue = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    ...
                    PercentageVariance = table.Column<decimal>(type: "numeric(10,4)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClientExpectations = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    OtherStakeholders = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    EnvIssues = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    EnvManagement = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    ThirdPartyIssues = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    ThirdPartyManagement = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    RiskIssues = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    RiskManagement = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    KnowledgeGoals = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    BaselineComparison = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    DelayedDeliverables = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    UnforeseeableDelays = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    BudgetEstimate = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    ProfitTarget = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    ChangeOrders = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    CloseOutBudget = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    ResourceAvailability = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    VendorFeedback = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    ProjectTeamFeedback = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    DesignOutputs = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    ProjectReviewMeetings = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    ClientDesignReviews = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    InternalReporting = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    ClientReporting = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    InternalMeetings = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    ClientMeetings = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    ExternalMeetings = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    PlanUpToDate = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    PlanUseful = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    Hindrances = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    ClientPayment = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    PlanningIssues = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    PlanningLessons = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    BriefAims = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    DesignReviewOutputs = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    ConstructabilityReview = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    DesignReview = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    TechnicalRequirements = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    InnovativeIdeas = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    SuitableOptions = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    AdditionalInformation = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    DeliverableExpectations = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    StakeholderInvolvement = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    KnowledgeGoalsAchieved = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    TechnicalToolsDissemination = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    SpecialistKnowledgeValue = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    OtherComments = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    TargetCostAccuracyValue = table.Column<bool>(type: "boolean", nullable: true),
                    TargetCostAccuracy = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    ChangeControlReviewValue = table.Column<bool>(type: "boolean", nullable: true),
                    ChangeControlReview = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    CompensationEventsValue = table.Column<bool>(type: "boolean", nullable: true),
                    CompensationEvents = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    ExpenditureProfileValue = table.Column<bool>(type: "boolean", nullable: true),
                    ExpenditureProfile = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    HealthSafetyConcernsValue = table.Column<bool>(type: "boolean", nullable: true),
                    HealthSafetyConcerns = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    ProgrammeRealisticValue = table.Column<bool>(type: "boolean", nullable: true),
                    ProgrammeRealistic = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    ProgrammeUpdatesValue = table.Column<bool>(type: "boolean", nullable: true),
                    ProgrammeUpdates = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    RequiredQualityValue = table.Column<bool>(type: "boolean", nullable: true),
                    RequiredQuality = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    OperationalRequirementsValue = table.Column<bool>(type: "boolean", nullable: true),
                    OperationalRequirements = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    ConstructionInvolvementValue = table.Column<bool>(type: "boolean", nullable: true),
                    ConstructionInvolvement = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    EfficienciesValue = table.Column<bool>(type: "boolean", nullable: true),
                    Efficiencies = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    MaintenanceAgreementsValue = table.Column<bool>(type: "boolean", nullable: true),
                    MaintenanceAgreements = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    AsBuiltManualsValue = table.Column<bool>(type: "boolean", nullable: true),
                    AsBuiltManuals = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    HsFileForwardedValue = table.Column<bool>(type: "boolean", nullable: true),
                    HsFileForwarded = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    Variations = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    TechnoLegalIssues = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    ConstructionOther = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    Positives = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    LessonsLearned = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    WorkflowStatusId = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    EndDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    SprintGoal = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    ProjectId = table.Column<int>(type: "integer", nullable: true),
                    RequiredSprintEmployees = table.Column<int>(type: "integer", nullable: false),
                    SprintName = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    PlannedStoryPoints = table.Column<int>(type: "integer", nullable: false),
                    ActualStoryPoints = table.Column<int>(type: "integer", nullable: false),
                    Velocity = table.Column<decimal>(type: "numeric(5,2)", nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    BidPreparationId = table.Column<int>(type: "integer", nullable: false),
                    Version = table.Column<int>(type: "integer", nullable: false),
                    DocumentCategoriesJson = table.Column<string>(type: "text", nullable: true),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    Comments = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GoNoGoDecisionHeaderId = table.Column<int>(type: "integer", nullable: true),
                    ScoringCriteriaId = table.Column<int>(type: "integer", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    UpdatedBy = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GoNoGoDecisionTransactions_GoNoGoDecisionHeaders_GoNoGoDeci~",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    TenantId = table.Column<int>(type: "integer", nullable: false),
                    GoNoGoDecisionHeaderId = table.Column<int>(type: "integer", nullable: false),
                    ...
                    Comments = table.Column<string>(type: "text", nullable: true),
                    ActonBy = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ChangeControlWorkflowHistories_ChangeControls_ChangeControl~",
                        column: x => x.ChangeControlId,
                        principalTable: "ChangeControls",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChangeControlWorkflowHistories_PMWorkflowStatuses_PMWorkflo~",
                        column: x => x.PMWorkflowStatusId,
                        principalTable: "PMWorkflowStatuses",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    TenantId = table.Column<int>(type: "integer", nullable: false),
                    MonthlyProgressId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantId = table.Column<int>(type: "integer", nullable: false),
                    MonthlyProgressId = table.Column<int>(type: "integer", nullable: false),
                    ContractTotal = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    ...
                    SummaryDetails = table.Column<string>(type: "text", nullable: true),
                    Status = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantId = table.Column<int>(type: "integer", nullable: false),
                    MonthlyProgressId = table.Column<int>(type: "integer", nullable: false),
                    PriorCumulativeOdc = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    PriorCumulativeStaff = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    PriorCumulativeTotal = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    ActualOdc = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    ActualStaff = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    ActualSubtotal = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    TotalCumulativeOdc = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    TotalCumulativeStaff = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    TotalCumulativeCost = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantId = table.Column<int>(type: "integer", nullable: false),
                    MonthlyProgressId = table.Column<int>(type: "integer", nullable: false),
                    CtcODC = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    CtcStaff = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    CtcSubtotal = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    ActualctcODC = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    ActualCtcStaff = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    ActualCtcSubtotal = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    EacOdc = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    EacStaff = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    TotalEAC = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    GrossProfitPercentage = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantId = table.Column<int>(type: "integer", nullable: false),
                    MonthlyProgressId = table.Column<int>(type: "integer", nullable: false),
                    WarningsDescription = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantId = table.Column<int>(type: "integer", nullable: false),
                    MonthlyProgressId = table.Column<int>(type: "integer", nullable: false),
                    Net = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    ServiceTax = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    FeeTotal = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    BudgetOdcs = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    BudgetStaff = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    BudgetSubTotal = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    ContractType = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantId = table.Column<int>(type: "integer", nullable: false),
                    MonthlyProgressId = table.Column<int>(type: "integer", nullable: false),
                    WorkAssignment = table.Column<string>(type: "text", nullable: true),
                    Assignee = table.Column<string>(type: "text", nullable: true),
                    Planned = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    Consumed = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    Balance = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    NextMonthPlanning = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    ManpowerComments = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantId = table.Column<int>(type: "integer", nullable: false),
                    MonthlyProgressId = table.Column<int>(type: "integer", nullable: false),
                    ProgrammeDescription = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DueDateContract = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    DueDatePlanned = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    AchievedDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    PaymentDue = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    InvoiceDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    PaymentReceivedDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    DeliverableComments = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantId = table.Column<int>(type: "integer", nullable: false),
                    MonthlyProgressId = table.Column<int>(type: "integer", nullable: false),
                    DateOfIssueWOLOI = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    CompletionDateAsPerContract = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    CompletionDateAsPerExtension = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    ExpectedCompletionDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProjectClosureWorkflowHistories_PMWorkflowStatuses_PMWorkfl~",
                        column: x => x.PMWorkflowStatusId,
                        principalTable: "PMWorkflowStatuses",
                        principalColumn: "Id");
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProjectClosureWorkflowHistories_ProjectClosures_ProjectClos~",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_WBSHistories_WBSTaskPlannedHourHeaders_WBSTaskPlannedHourHe~",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    TenantId = table.Column<int>(type: "integer", nullable: false),
                    BudgetTableId = table.Column<int>(type: "integer", nullable: false),
                    RevenueFee = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    Cost = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    ProfitPercentage = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Units = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalTimeCost = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    ...
                    ProjectFees = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    ServiceTaxPercentage = table.Column<decimal>(type: "numeric(5,2)", precision: 5, scale: 2, nullable: false),
                    ServiceTaxAmount = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    TotalProjectFees = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SubtaskCommentId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    TenantId = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SubtaskId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Subtaskkey = table.Column<string>(type: "text", nullable: true),
                    TenantId = table.Column<int>(type: "integer", nullable: false),
                    Subtasktitle = table.Column<string>(type: "text", nullable: true),
                    Subtaskdescription = table.Column<string>(type: "text", nullable: true),
                    Subtaskpriority = table.Column<string>(type: "text", nullable: true),
                    Subtaskstatus = table.Column<string>(type: "text", nullable: true),
                    SubtaskAssineid = table.Column<string>(type: "text", nullable: true),
                    SubtaskAssigneeName = table.Column<string>(type: "text", nullable: true),
                    SubtaskAssigneeAvatar = table.Column<string>(type: "text", nullable: true),
                    SubtaskReporterId = table.Column<string>(type: "text", nullable: true),
                    SubtaskReporterName = table.Column<string>(type: "text", nullable: true),
                    SubtaskReporterAvatar = table.Column<string>(type: "text", nullable: true),
                    Attachments = table.Column<int>(type: "integer", nullable: true),
                    SubtaskisExpanded = table.Column<bool>(type: "boolean", nullable: true),
                    SubtaskcreatedDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    SubtaskupdatedDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    SubtaskType = table.Column<string>(type: "text", nullable: true),
                    Taskid = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Taskid = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    TenantId = table.Column<int>(type: "integer", nullable: false),
                    Taskkey = table.Column<string>(type: "text", nullable: true),
                    ...
                    TaskAssineid = table.Column<string>(type: "text", nullable: true),
                    TaskAssigneeName = table.Column<string>(type: "text", nullable: true),
                    TaskAssigneeAvatar = table.Column<string>(type: "text", nullable: true),
                    TaskReporterId = table.Column<string>(type: "text", nullable: true),
                    TaskReporterName = table.Column<string>(type: "text", nullable: true),
                    TaskReporterAvatar = table.Column<string>(type: "text", nullable: true),
                    Taskstatus = table.Column<string>(type: "text", nullable: true),
                    StoryPoints = table.Column<int>(type: "integer", nullable: true),
                    Attachments = table.Column<int>(type: "integer", nullable: true),
                    IsExpanded = table.Column<bool>(type: "boolean", nullable: true),
                    TaskcreatedDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    TaskupdatedDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    SprintPlanId = table.Column<int>(type: "integer", nullable: true),
                    WbsPlanId = table.Column<int>(type: "integer", nullable: true),
                    SprintWbsPlanId = table.Column<int>(type: "integer", nullable: true),
                    UserTaskId = table.Column<int>(type: "integer", nullable: true),
                    AcceptanceCriteria = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    DisplayOrder = table.Column<int>(type: "integer", nullable: false),
                    EstimatedHours = table.Column<int>(type: "integer", nullable: false),
                    ActualHours = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WBSTaskVersionHistories_WBSVersionHistories_WBSVersionHisto~",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_WBSVersionWorkflowHistories_WBSVersionHistories_WBSVersionH~",
                        column: x => x.WBSVersionHistoryId,
                        principalTable: "WBSVersionHistories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WBSTaskPlannedHourVersionHistories_WBSTaskVersionHistories_~",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WBSTaskPlannedHours_WBSTaskPlannedHourHeaders_WBSTaskPlanne~",
                        column: x => x.WBSTaskPlannedHourHeaderId,
                        principalTable: "WBSTaskPlannedHourHeaders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_JobStartForms_WorkBreakdownStructures_WorkBreakdownStructur~",
                table: "JobStartForms",
                column: "WorkBreakdownStructureId",
                principalTable: "WorkBreakdownStructures",
                principalColumn: "Id");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_UserWBSTaskVersionHistories_WBSTaskVersionHistories_WBSTask~",
                table: "UserWBSTaskVersionHistories",
                column: "WBSTaskVersionHistoryId",
                principalTable: "WBSTaskVersionHistories",
                principalColumn: "Id",
