...
const mockReports: MonthlyReport[] = [
  {
    ...
    manpowerPlanning: { manpower: [], manpowerTotal: { plannedTotal: 0, consumedTotal: 0, approvedTotal: 0, extraHoursTotal: 0, paymentTotal: 0, balanceTotal: 0, nextMonthPlanningTotal: 0 } },
