// Interface for Positives and Lessons Learned
export interface IProjectClosureComment {
  id: string;
  projectId: string;
...
export interface IProjectClosureRow {
  projectId: string;
...
// UI Labels mapping for human-readable display
...
export const dummyProjectClosures: IProjectClosureRow[] = [];
export const dummyProjectClosureComments: IProjectClosureComment[] = [];
