...
// Utility functions
export const getOpportunityHistoryById = (id: string): OpportunityHistory | undefined => {
  return opportunityHistories.find(history => history.id === id);
};

export const getHistoriesByOpportunityId = (opportunityId: string): OpportunityHistory[] => {
